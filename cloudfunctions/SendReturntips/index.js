...
let cred = new Credential('AKIDsWt1udTKIzWrvib4NQDjywdQ3QeeswHN','ReaLr75oGTAh14rOd2astfAPO9oNfgQt');
...
req.SmsSdkAppid = "1400343484";
/* 短信签名内容: 使用 UTF-8 编码，必须填写已审核通过的签名，可登录 [短信控制台] 查看签名信息 */
req.Sign = "QSCamera";  //必须是审核过了的签名
...
exports.main = async (event, context) => {
  // const wxContext = cloud.getWXContext()
    ...
    * 例如+8613711112222， 其中前面有一个+号 ，86为国家码，13711112222为手机号，最多不要超过200个手机号*/
    let num = '+86' + event.myphone
    req.PhoneNumberSet = [num];
    /* 模板 ID: 必须填写已审核通过的模板 ID，可登录 [短信控制台] 查看模板 ID */
    req.TemplateID = "735756";
    /* 模板参数: 若无模板参数，则设置为空*/
    let code1 = event.borrowman
    let code2 = event.equip
    let code3 = event.returntime
    let code4 = event.nowtime
    req.TemplateParamSet = [code1,code2,code3,code4];
